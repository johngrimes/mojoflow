...
- If using Claude for the main build agent, use Opus (medium effort) for
  `quest` subagents, Fable (medium) for reviewer subagents.
- Otherwise, use GLM 5.3 Flash (high) for `quest` subagents, GLM 5.3 (high) for
  reviewer subagents.
